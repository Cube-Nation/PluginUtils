...
public class VaultWrapper {
	...
	public static void loadPlugin() {
		if (vault == null) {
			vault = (net.milkbowl.vault.Vault) Bukkit.getServer()
					.getPluginManager()
					.getPlugin(WrapperManager.Plugins.VAULT.getName());
			if (vault == null) {
	...
	public static Economy getService() {
		...
		if (vault != null) {
			RegisteredServiceProvider<net.milkbowl.vault.economy.Economy> rsp = Bukkit
					.getServer().getServicesManager()
					.getRegistration(net.milkbowl.vault.economy.Economy.class);
			if (rsp != null) {
				net.milkbowl.vault.economy.Economy economy = rsp.getProvider();
				log.info("Connected to " + economy.getName()
						+ " for economy support.");
	...
	public static class EconomyResponse {
		...
		public EconomyResponse(
				net.milkbowl.vault.economy.EconomyResponse economyResponse) {
